...
$batter_id = $_GET['batterId'];
$pitcher_id = $_GET['pitcherId'];
...
$rc=$pStmt->bind_param('s',$batter_id);
if(false===$rc){
...
$rc=$pStmt->bind_param('s',$pitcher_id);
if(false===$rc){
	die("bind failed: ".htmlspecialchars($pStmt->error));
}
...
exec("/home/jsryu21/match_predictor.py {$batter_id} {$pitcher_id}", $output);
