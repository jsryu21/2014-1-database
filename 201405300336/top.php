...
while($row=mysql_fetch_assoc($result)){
	...
	if($colName=$engToKor[$row['COLUMN_NAME']]){
		echo "<td><a href=/top_fix.php?rank={$_GET['rank']}&pStat={$row['COLUMN_NAME']}&bStat={$_GET['bStat']}&name={$_GET['name']}>{$colName}</a></td>";
	}else{
		echo "<td><a href=/top_fix.php?rank={$_GET['rank']}&pStat={$row['COLUMN_NAME']}&bStat={$_GET['bStat']}&name={$_GET['name']}>{$row['COLUMN_NAME']}</a></td>";
	}
}
echo "</tr>";
...
while($row=mysql_fetch_assoc($result)){
	...
	if($colName=$engToKor[$row['COLUMN_NAME']]){
		echo "<td><a href=/top_fix.php?rank={$_GET['rank']}&pStat={$_GET['pStat']}&bStat={$row['COLUMN_NAME']}&name={$_GET['name']}>{$colName}</a></td>";
	}else{
		echo "<td><a href=/top_fix.php?rank={$_GET['rank']}&pStat={$_GET['pStat']}&bStat={$row['COLUMN_NAME']}&name={$_GET['name']}>{$row['COLUMN_NAME']}</a></td>";
	}
}
echo "</tr>";
